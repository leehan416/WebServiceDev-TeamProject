<div class="container">
    <header class="d-flex flex-wrap justify-content-between align-items-center py-3 mb-4 border-bottom">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a href="${pageContext.request.contextPath}/performance/list" class="nav-link">Performance List</a>
            </li>
            <li class="nav-item">
                <a href="${pageContext.request.contextPath}/performance/write" class="nav-link">Add New</a>
            </li>
            <li class="nav-item">
                <a href="${pageContext.request.contextPath}/user/reservations" class="nav-link">My Reservations</a>
            </li>
            <li class="nav-item">
